...
def build_ma_crossover_strategy(short_window: int, long_window: int) -> MovingAverageCrossoverStrategy:
    """
    Return an instance of the Stratestic MA crossover strategy configured with the given parameters.
    """

    return MovingAverageCrossoverStrategy(short_window=short_window, long_window=long_window)
