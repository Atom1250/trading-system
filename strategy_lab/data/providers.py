...
from strategy_lab.data.base import DataProvider, OHLCVData, HistoricalDataProvider, MarketDataSlice
...
class YFinanceHistoricalProvider(HistoricalDataProvider):
    ...
    def get_history(self, symbol: str, start: datetime, end: datetime) -> MarketDataSlice:
        try:
