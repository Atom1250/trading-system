...
class RiskAssessmentService:
    ...
    def assess_risk(self, symbol: str, data_source: str = "local") -> dict[str, Any]:
        ...
        if max_drawdown < -0.2:
            recommendations.append(
                "Significant drawdown detected - review position sizing",
            )
        if sharpe_ratio < 0.5:
            recommendations.append(
                "Low risk-adjusted returns - consider alternative strategies",
            )
