...
FMP_BASE_URL = os.environ.get("FMP_BASE_URL", "https://financialmodelingprep.com/stable/api/v3")
FMP_FALLBACK_BASE_URL = os.environ.get("FMP_FALLBACK_BASE_URL", "https://financialmodelingprep.com/api/v3")
