...
from strategy_lab.config import RiskConfig, CapitalAllocationMode, EntryMode
from strategy_lab.risk.engine import RiskEngine, RiskViolation
from strategy_lab.risk.portfolio_state import PortfolioState, PositionSide, PositionState
...
class TestRiskEngine(unittest.TestCase):
    ...
    def test_position_sizing_compounding(self):
        ...
        self.engine.risk_config.capital_allocation_mode = CapitalAllocationMode.COMPOUNDING
